...
class SimulatorConfig(object):
  ...
  def __init__(self, max_steps_per_movement, allowed_movement_directions,
    ...
    Arguments:
      ...
      humidity_precipitations      Part of precipitations contribution for humidity
      moore_amplitude              Influence of moore neighborhood in items regeneration.
      threshold_humidity           Threshold for humidity: above, no changes in the 
                                   intensity of water cells.
      precipitations_fn            The PrecipitationsFunction used for the climate
  ...
  def __init__(
    ...
    if sim_config != None:
      ...
      self._handle = simulator_c.new(sim_config.seed,
        ...
        [(i.name, i.scent, i.color, i.required_item_counts, i.required_item_costs, i.blocks_movement, i.visual_occlusion, i.intensity_fn, i.intensity_fn_args, i.interaction_fns, i.regeneration_fn, i.regeneration_fn_args, i.lifetime) for i in sim_config.items],
